...
>
    <div class="flex max-h-[min(92vh,860px)] w-full max-w-[980px] flex-col overflow-hidden rounded-[12px] border border-white/15 bg-[#141414] text-white shadow-2xl" @click.stop>
        ...
        <div class="flex flex-wrap gap-[4px] border-b border-white/10 px-[16px] pt-[10px]">
        ...
        <div class="grid min-h-0 flex-1 gap-0 overflow-y-auto lg:grid-cols-[240px_minmax(0,1fr)]">
            <aside class="space-y-[10px] border-b border-white/10 px-[16px] py-[16px] lg:border-b-0 lg:border-r">
                <div class="rounded-[8px] border border-white/10 bg-black/25 px-[10px] py-[10px]">
                ...
                <template x-if="installTagsModal.tab === 'google_tag'">
                    <div class="space-y-[12px]">
                        ...
                        <label class="block max-w-[320px]">
                            ...
                            <input type="text" class="ae-field w-full rounded-[6px] border border-white/20 px-[10px] py-[8px] text-[12px]" x-model="installTagsModal.google_tag_id" placeholder="AW-…">
                        </label>
                    </div>
                </template>
                    ...
                    <div class="space-y-[14px]">
                        <div class="grid gap-[10px] sm:grid-cols-2">
                            <label class="block">
                                ...
                                <input type="text" class="ae-field w-full rounded-[6px] border border-white/20 px-[10px] py-[8px] text-[12px]" x-model="installTagsModal.gtm_id" placeholder="GTM-…">
                            </label>
                            <label class="block">
                                <span class="mb-[4px] block text-[11px] font-semibold text-white/70">Workspace</span>
                                <select class="ae-field w-full rounded-[6px] border border-white/20 px-[10px] py-[8px] text-[12px]" x-model="installTagsModal.workspace">
                        ...
                        <div>
                            ...
                            <ul class="space-y-[6px]">
                                <template x-for="tag in installTagsModal.requiredTags" :key="tag.name">
                                    <li class="flex items-center justify-between gap-[8px] rounded-[8px] border border-white/10 bg-black/25 px-[12px] py-[10px] text-[12px]">
                                        <div>
                        ...
                        <div>
                            ...
                            <pre class="overflow-x-auto rounded-[8px] border border-white/10 bg-black/40 p-[12px] font-mono text-[11px] text-emerald-200">window.dataLayer = window.dataLayer || [];
window.dataLayer.push({
  ...
  risk_confidence: 'high'
        ...
        <footer class="flex flex-wrap items-center justify-end gap-[8px] border-t border-white/15 px-[22px] py-[14px]">
