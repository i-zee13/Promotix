...
<div
    class="fixed inset-0 z-[100] flex items-center justify-center bg-black/75 p-[16px]"
...
>
    <div class="flex max-h-[min(92vh,820px)] w-full max-w-[920px] flex-col overflow-hidden rounded-[12px] border border-white/15 bg-[#141414] text-white shadow-2xl" @click.stop>
        <header class="flex items-start justify-between gap-[12px] border-b border-white/15 px-[22px] py-[16px]">
            <div>
        ...
        <div class="border-b border-white/10 px-[22px] py-[12px]">
        ...
        <div class="grid min-h-0 flex-1 gap-[0] overflow-y-auto lg:grid-cols-2">
            <div class="space-y-[12px] border-b border-white/10 px-[22px] py-[18px] lg:border-b-0 lg:border-r">
                <label class="block">
                    <span class="mb-[4px] block text-[11px] font-semibold text-white/70">Google login</span>
                    <input type="text" class="ae-field w-full rounded-[6px] border border-white/20 px-[10px] py-[8px] text-[12px]" :value="googleAdsSummary.email || 'Not connected'" readonly>
                </label>
                <label class="block">
                    <span class="mb-[4px] block text-[11px] font-semibold text-white/70">Manager account (optional)</span>
                    <select class="ae-field w-full rounded-[6px] border border-white/20 px-[10px] py-[8px] text-[12px]" x-model="connectGoogleModal.manager_id">
                ...
                <label class="block">
                    ...
                    <input type="text" class="ae-field w-full rounded-[6px] border border-white/20 px-[10px] py-[8px] text-[12px]" placeholder="123-456-7890" x-model="connectGoogleModal.customer_id">
                ...
                <label class="block">
                    ...
                    <select class="ae-field w-full rounded-[6px] border border-white/20 px-[10px] py-[8px] text-[12px]" x-model="connectGoogleModal.domain_id">
                ...
                <label class="block">
                    ...
                    <input type="text" class="ae-field w-full rounded-[6px] border border-white/20 px-[10px] py-[8px] text-[12px]" placeholder="AW-123456789" x-model="connectGoogleModal.google_tag_id">
                </label>
                <label class="block">
                    <span class="mb-[4px] block text-[11px] font-semibold text-white/70">GTM Container (optional)</span>
                    <input type="text" class="ae-field w-full rounded-[6px] border border-white/20 px-[10px] py-[8px] text-[12px]" placeholder="GTM-XXXXXXX" x-model="connectGoogleModal.gtm_id">
                </label>
            </div>
                ...
                <div>
                    ...
                    <ul class="space-y-[6px]">
                        <template x-for="perm in connectGoogleModal.permissions" :key="perm.key">
                            <li class="flex items-center justify-between gap-[8px] rounded-[6px] border border-white/10 bg-black/25 px-[10px] py-[8px] text-[12px]">
        ...
        <footer class="flex flex-wrap items-center justify-between gap-[10px] border-t border-white/15 px-[22px] py-[14px]">
