    ...
    <div class="w-full max-w-md mt-6 md:mt-0 md:ml-[-80px] md:flex-shrink-0 order-1 md:order-2 relative z-10">
        <div class="bg-gray-200 rounded-2xl p-8 shadow-2xl">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                {{-- Google box (UI only) --}}
                <a href="{{ route('integrations.google.redirect', ['context' => 'auth']) }}" class="w-full py-3 rounded-xl bg-gray-300 text-gray-800 font-medium flex items-center justify-center gap-3 hover:bg-gray-400 transition">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
                        <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                        <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                        <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
