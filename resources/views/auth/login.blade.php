...
>
    ...
    <form method="POST" action="{{ route('login') }}" x-data="{ showPwd: false }" id="login-form">
        ...
        <div class="auth-field">
            <label class="auth-field-label" for="email">Your email</label>
            <input
                id="email"
                type="email"
                name="email"
        ...
        <div class="auth-social-row">
            ...
            @if (Route::has('register'))
                <a href="{{ route('register') }}" class="auth-social-btn" aria-label="Create account" title="Create account" style="font-size:0.78rem;font-weight:600;color:inherit;">
                    Sign up
                </a>
            @endif
        </div>
