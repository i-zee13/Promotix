    ...
    <div class="max-w-3xl w-full rounded-2xl p-8 sm:p-12 md:p-16 bg-gradient-to-b from-purple-700 to-purple-900 shadow-2xl border border-purple-400/30">
        <div class="max-w-md mx-auto">
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <button type="button" class="w-full py-3 rounded-lg bg-gray-200 text-gray-800 font-medium flex items-center justify-center gap-3 hover:bg-gray-300 transition">
